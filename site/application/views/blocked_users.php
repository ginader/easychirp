...
<div class="box1 rounded" style="padding: 1em;">
	...
	if (isset($blockList)) {
		...
		foreach ($blockList as $user) {
			...
			echo '<span aria-hidden="true" class="icon-blocked"></span> <span class="span-user-blocked">'.$xliff_reader->get('gbl-blocked').'</span> <a href="/block_destroy/'.$user->screen_name.'/false">'.$xliff_reader->get('user-unblock').'</a>';
			echo "</li>";
		}
		echo "</ul>";
	}
