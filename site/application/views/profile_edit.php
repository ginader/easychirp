...
<div class="box1 rounded" style="margin-top: 1.65rem">
	<h2>[AVATAR] <?php echo $xliff_reader->get('edit-profile-h1'); ?></h2>
	<form id="frmProfileEdit" action="actions/doSettings.php" method="post">
		<dl id="profile" class="editProfile">
			...
			<dt><label for="email"><?php echo $xliff_reader->get('edit-profile-email'); ?></label></dt>
...
<div class="box1 rounded">
	<h2><?php echo $xliff_reader->get('edit-profile-avatar-h2'); ?></h2>
