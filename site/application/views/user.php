...
>
	...
	?>
	<h3><a rel="noopener noreferrer" target="_blank" href="<?php echo $profileImageLongURL; ?>" title="<?php echo $xliff_reader->get('user-pic-open-orig'); ?>"><img src="<?php echo $user->profile_image_url; ?>" width="48" height="48" alt="<?php echo $xliff_reader->get('user-pic-alt'); ?>" /></a>
		<?php 
	...
	<p>
		<a href="/direct_send_page/<?php echo $user->screen_name; ?>/<?php echo $user->id; ?>"><?php echo $xliff_reader->get('gbl-tweet-dm'); ?></a> | 
