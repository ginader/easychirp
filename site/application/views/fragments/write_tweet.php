	...
	data-char-remain="<?php echo $xliff_reader->get('write-tweet-char-remain'); ?>">
		...
		<legend><?php echo $xliff_reader->get('add-image-hd'); ?></legend>
			...
			<div>
				...
				<textarea name="imageDesc" id="imageDesc" class="input1"></textarea>
			</div>
			<div>
				...
				<a href="/img_help" rel="noopener noreferrer" target="_blank" id="img_help"><?php echo $xliff_reader->get('add-image-help-desc'); ?></a>
			</div>
		</fieldset>
		</form>
	</div>
