		...
		<ul id="tweetOptions_<?php echo $index; ?>">
			...
			<li><?php 
				if ($tweet->retweeted === false) { 
					echo '<a href="/retweet/create/' . $tweet->id . '/false" data-icon="&#x3f;" title="' . $xliff_reader->get('gbl-tweet-make-rt') . '"><span class="hide">' . $xliff_reader->get('gbl-tweet-make-rt') . '</span></a>';
				}
				else {
					echo '<a data-icon="&#x3f;" class="retweeted" title="retweeted"><span class="hide">retweeted</span></a>';
					//echo '<a href="/retweet/destroy/' . $tweet->id . '/false" data-icon="&#x3f;" class="retweeted" title="' . $xliff_reader->get('gbl-tweet-remove-rt') . '"><span class="hide">' . $xliff_reader->get('gbl-tweet-remove-rt') . '</span></a>';
				}
			?></li>
