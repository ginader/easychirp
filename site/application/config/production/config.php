...
|
*/
$config['base_url'] = 'http://www.easychirp.com/';
...
$config['main_menu'] = array(
	...
	,'/profile_edit' => array(
		'id' => 'm_profile_edit', 
		'lang-id' => 'edit-profile-h1', 
		'label' => 'Edit Profile', 
		'parent' => '/profile')
	,'/muted_users' => array(
		'id' => 'm_profile_muted_users', 
		'lang-id' => 'gbl-muted-users', 
		'label' => 'Muted Users', 
		'parent' => '/profile')
	,'/blocked_users' => array(
		'id' => 'm_profile_blocked_users', 
		'lang-id' => 'gbl-blocked-users', 
		'label' => 'Blocked Users', 
		'parent' => '/profile')
	,'/tips' => array(
		'id' => 'm_tips', 
	...
	,'/articles' => array(
		'id' => 'm_articles', 
		'lang-id' => 'nav-articles', 
		'label' => 'Articles &amp; Feedback', 
		'parent' => '')
	,'/features' => array(
		'id' => 'm_features', 
		'lang-id' => 'nav-features', 
		'label' => 'Features', 
		'parent' => '')
	,'/about' => array(
		'id' => 'm_about', 
...
$config['tweet_menu'] = array(
	'/timeline' => array(
		'id' => 'm_timeline', 
		'access_key' => '1', 
		'lang-id' => 'nav-timeline', 
		'label' => 'Timeline', 
		'parent' => '')
	,'/mentions' => array(
		'id' => 'm_mentions', 
		'access_key' => '2', 
		'lang-id' => 'nav-mentions', 
		'label' => 'Mentions', 
		'parent' => '')
	,'/favorites' => array(
		'id' => 'm_favorites', 
		'lang-id' => 'nav-favorites', 
		'access_key' => '3', 
		'label' => 'Favorites', 
		'parent' => '')
	,'/retweets' => array(
