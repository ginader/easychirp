...
$route['direct'] = "main/direct_inbox";//direct"; // For non-JS (menu)
$route['direct_send_page/(:any)/(:any)'] = "main/direct_send_page/$1/$2"; // to screen_name, id
...
$route['list_subscribers/(:any)/(:any)/(:any)/(:any)'] = "main/list_subscribers/$1/$2/$3/$4";
$route['list_members/(:any)/(:any)/(:any)'] = "main/list_members/$1/$2/$3";
$route['list_members/(:any)/(:any)/(:any)/(:any)'] = "main/list_members/$1/$2/$3/$4";
$route['listed'] = "main/listed";
$route['listed/(:any)'] = "main/listed/$1";
